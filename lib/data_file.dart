...
class PortfolioDetails {
  ...
  static String educationHeadLine =
      "I pursued my B.Tech in the 2019–2023 batch from the Indian Institute of Information Technology (IIIT), Kurnool. During this period, I explored various domains and worked on Android Development, Web Development, Cross-Platform Development, Game Development, Machine Learning, IoT, Digital Twins, AR/VR, CAD Designing, and more. I created several industry-level projects and also completed multiple internships in various startups and companies. I completed multiple certified and uncertified courses in different domains. Apart from these, I actively participated in club activities as well. I served as the Photography Club Coordinator, Placement Cell Coordinator, Marketing Team Member, Android Lead in the Google Developer Student Club, Flutter Facilitator in the Flutter Festival, Guitarist in the Music Club, and many more.";
